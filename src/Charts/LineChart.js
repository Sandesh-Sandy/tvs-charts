...
const LineChart = () => {
  ...
  useEffect(() => {
    ...
    const data = [
      ...
      { date: "May", plan: 12, "Revised Plan": 11, lastYear: null },
      ...
      { date: "Sep", plan: 12, "Revised Plan": 11, lastYear: 11 },
      { date: "Oct", plan: 7, "Revised Plan": 6, lastYear: 4 },
      ...
      { date: "Feb", plan: 9, "Revised Plan": 5, lastYear: 6 },
    ...
    const series = ["plan", '"Revised Plan"', "lastYear"];
